...
class AreaConfigReaderTest : AbstractNetconfHandlerTest() {
    @Mock
    private lateinit var readContext: ReadContext

    private lateinit var underlayAccess: UnderlayAccess

    private lateinit var target: AreaConfigReader

    companion object {
        private val NC_HELPER = NetconfAccessHelper("/area_nodes.xml")
    }
    ...
    fun setUp() {
        ...
        target = Mockito.spy(AreaConfigReader())
    }
    ...
    fun testReadCurrentAttributes() {
        ...
        val id = InstanceIdentifier
                ...
                .child(NetworkInstance::class.java, NetworkInstanceKey("iups"))
                .child(Protocols::class.java)
                .child(Protocol::class.java, ProtocolKey(OSPF::class.java, "400"))
        ...
        Assert.assertEquals(configBuilder.identifier.uint32, areaId)
    }
}