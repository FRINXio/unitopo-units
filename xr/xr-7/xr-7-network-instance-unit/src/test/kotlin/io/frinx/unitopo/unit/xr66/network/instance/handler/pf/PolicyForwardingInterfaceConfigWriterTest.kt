...
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.qos.ma.cfg.rev190405.InterfaceConfiguration1
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.qos.ma.cfg.rev190405.qos.Qos
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.qos.ma.cfg.rev190405.qos.QosBuilder
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.qos.ma.cfg.rev190405.qos.qos.InputBuilder
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.qos.ma.cfg.rev190405.qos.qos.OutputBuilder
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.qos.ma.cfg.rev190405.service.policy.ServicePolicy
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.qos.ma.cfg.rev190405.service.policy.ServicePolicyBuilder
...
class PolicyForwardingInterfaceConfigWriterTest : AbstractNetconfHandlerTest() {
    ...
    fun testUpdateCurrentAttributes() {
        ...
        Mockito.verify(underlayAccess, Mockito.times(1)).safeMerge(idCap.capture(),
            dataCap.capture(), Mockito.any(), Mockito.any())
    }
