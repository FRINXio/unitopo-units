...
class Ipv6AddressConfigReaderTest : AbstractNetconfHandlerTest() {
    @Mock
    private lateinit var readContext: ReadContext

    private lateinit var underlayAccess: UnderlayAccess

    private lateinit var target: Ipv6AddressConfigReader
    ...
    fun setUp() {
        ...
        target = Mockito.spy(Ipv6AddressConfigReader(underlayAccess))
    }
    ...
    fun testReadCurrentAttributes() {
        ...
        Assert.assertEquals(builder.prefixLength, prefixLength)
    }
}