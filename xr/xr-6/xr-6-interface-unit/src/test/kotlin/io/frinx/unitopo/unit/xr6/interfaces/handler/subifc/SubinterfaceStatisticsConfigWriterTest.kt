...
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.infra.statsd.cfg.rev151109._interface.configurations._interface.configuration.Statistics as underlayStatictics
...
class SubinterfaceStatisticsConfigWriterTest : AbstractNetconfHandlerTest() {
    ...
    companion object {
        ...
        private val NATIVE_IFC_NAME = InterfaceName("GigabitEthernet0/0/0/0.2147483647")
