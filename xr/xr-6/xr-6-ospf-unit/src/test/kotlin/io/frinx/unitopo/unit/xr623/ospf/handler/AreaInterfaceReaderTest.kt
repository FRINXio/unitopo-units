...
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.ipv4.ospf.cfg.rev170102.area.table.area.addresses.area.content.name.scopes.NameScope
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.ipv4.ospf.cfg.rev170102.area.table.area.addresses.area.content.name.scopes.NameScopeKey
...
class AreaInterfaceReaderTest : AbstractNetconfHandlerTest() {
    ...
    companion object {
        ...
        private val IID_AREA_INSTANCE = KeyedInstanceIdentifier
                ...
                .child(AreaAreaId::class.java, AreaAreaIdKey(areaId.toInt()))
