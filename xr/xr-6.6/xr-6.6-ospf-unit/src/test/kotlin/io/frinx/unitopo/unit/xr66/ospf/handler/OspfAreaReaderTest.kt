...
class OspfAreaReaderTest : AbstractNetconfHandlerTest() {
    @Mock
    private lateinit var readContext: ReadContext

    private lateinit var underlayAccess: UnderlayAccess

    private lateinit var target: OspfAreaReader
    ...
    fun setUp() {
        ...
        target = Mockito.spy(OspfAreaReader(underlayAccess))
    }
    ...
    fun testReadCurrentAttributes() {
        ...
        target.readCurrentAttributes(id, areaBuilder, readContext)

        Assert.assertEquals(areaBuilder.identifier.uint32, areaId)
    }
}