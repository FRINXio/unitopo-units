...
class IngressAclSetConfigWriterTest {
    ...
    private lateinit var target: IngressAclSetConfigWriter
    ...
    companion object {
        ...
        private val INPUT_FILTER_NAME = "FBF-MS-THU-RETURN-INPUT"
        private val INGRESS_ACL_SET_KEY = IngressAclSetKey(INPUT_FILTER_NAME, ACL_TYPE)
        private val IID_CONFIG = IIDs.AC_INTERFACES
            .child(Interface::class.java, InterfaceKey(InterfaceId(IF_ID)))
            .child(IngressAclSets::class.java)
            .child(IngressAclSet::class.java, INGRESS_ACL_SET_KEY)
            .child(Config::class.java)

        private val CONFIG = ConfigBuilder()
            .setSetName(INPUT_FILTER_NAME)
            .setType(ACL_TYPE)
            .build()
        ...
        private val INGRESS_ACL_SET_KEY_INET6 = IngressAclSetKey(INPUT_FILTER_NAME, ACL_TYPE_INET6)
        private val IID_CONFIG_INET6 = IIDs.AC_INTERFACES
            .child(Interface::class.java, InterfaceKey(InterfaceId(IF_ID)))
            .child(IngressAclSets::class.java)
            .child(IngressAclSet::class.java, INGRESS_ACL_SET_KEY_INET6)
            .child(Config::class.java)
        ...
        private val NATIVE_CONFIG = InputBuilder(DATA_JUNOS_IFC).build()
    }
    ...
    fun testWriteCurrentAttributes_Normal() {
        ...
        val config = ConfigBuilder(CONFIG)
            .build()
        val expectedConfig = InputBuilder(NATIVE_CONFIG)
            .build()

        val idCap = ArgumentCaptor
            .forClass(InstanceIdentifier::class.java) as ArgumentCaptor<InstanceIdentifier<Input>>
        val dataCap = ArgumentCaptor
            .forClass(DataObject::class.java) as ArgumentCaptor<Input>
