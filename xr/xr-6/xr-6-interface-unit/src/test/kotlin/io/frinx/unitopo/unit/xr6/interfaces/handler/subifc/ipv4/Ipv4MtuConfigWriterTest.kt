...
import org.opendaylight.yang.gen.v1.http.cisco.com.ns.yang.cisco.ios.xr.ipv4.io.cfg.rev150730._interface.configurations._interface.configuration.Ipv4NetworkBuilder
...
class Ipv4MtuConfigWriterTest {
    ...
    companion object {
        ...
        private val NATIVE_IF_NAME = InterfaceName(IF_NAME + ".2147483647")
